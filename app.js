...
const maqonWhiteSync=document.querySelector('#proposalEquipment');
if(maqonWhiteSync)maqonWhiteSync.addEventListener('change',()=>{
 const eq=equipments[Number(maqonWhiteSync.value)],v=document.querySelector('#proposalValue');
...
function viewProposal(i){
 ...
 const key=norm(category),id=norm(maker+' '+model);
 ...
 else if(key.includes('motonivel')){photo='maqon-motoniveladora.jpg';desc='Motoniveladora para nivelamento, acabamento e conformação de vias e terrenos.'}
 ...
 else if(key.includes('pipa')){photo='maqon-caminhao-pipa.jpg';desc='Caminhão-pipa para abastecimento, umectação de vias e apoio operacional.'}
 ...
 *{box-sizing:border-box}html,body{margin:0;background:#e9edf0;color:#111;font-family:Arial,Helvetica,sans-serif}.toolbar{height:50px;background:#101820;color:#fff;display:flex;justify-content:space-between;align-items:center;padding:0 18px;position:sticky;top:0;z-index:20}.toolbar button{border:0;border-radius:5px;padding:9px 13px;font-weight:800;margin-left:7px;cursor:pointer}.gold{background:#f7c500}.dark{background:#34434b;color:#fff}.stage{display:flex;justify-content:center;padding:14px}.sheet{width:900px;max-width:100%;background:#fff;border:1px solid #c9c9c9;box-shadow:0 12px 45px #777;overflow:hidden}.hero{height:285px;display:grid;grid-template-columns:1fr 225px;background:url('maqon-banner-v4.png') center/cover no-repeat;border-bottom:3px solid #e7b900}.identity{padding:35px 30px;display:flex;flex-direction:column;justify-content:flex-end;text-shadow:0 2px 5px #000}.logo{font-size:52px;font-weight:900;color:#fff}.logo b{color:#f6c400}.tag{font-size:15px;color:#fff;font-weight:800}.strategy{font-size:10px;color:#fff;margin-top:8px}.future{font-size:16px;color:#ffd000;margin-top:35px}.future b{display:block;font-size:21px}.proposal{background:#fff;color:#111;border:1px solid #222;border-left:5px solid #e7b900;padding:24px 18px;overflow:hidden}.proposal h1{font-size:22px;line-height:1.05;margin:0}.proposal h1 b{display:block;color:#e6a900;font-size:29px}.proposal .num{font-size:15px;font-weight:900;margin:9px 0 19px}.benefit{font-size:11px;line-height:1.22;margin:10px 0;white-space:nowrap}.body{padding:0 24px 16px;background:#fff}.section{display:flex;align-items:center;gap:12px;color:#111;font-size:18px;font-weight:900;margin:12px 0}.section:before{content:"●";color:#e8b400}.section:after{content:"";height:3px;background:#e8b400;flex:1}.grid2,.grid3{display:grid;gap:9px}.grid2{grid-template-columns:1fr 1fr}.grid3{grid-template-columns:repeat(3,1fr)}.card,.details,.scope{background:#fff;border:1px solid #333;border-radius:7px}.card{padding:12px 16px;min-height:64px}.card small,.details small,.spec small{display:block;color:#555;font-size:10px;margin-bottom:6px}.card strong{font-size:16px}.equipment{display:grid;grid-template-columns:48% 52%;gap:12px}.photo{height:235px;background:url('${photo}') center/cover no-repeat;border:2px solid #e0ae00;border-radius:7px}.details{padding:17px 20px}.details h2{color:#d89e00;font-size:23px;margin:0 0 16px}.details p{font-size:14px;line-height:1.5;min-height:62px}.specs{display:grid;grid-template-columns:repeat(3,1fr);border-top:1px solid #777;padding-top:15px}.spec{padding:0 12px;border-right:1px solid #777}.spec:first-child{padding-left:0}.spec:last-child{border:0}.spec b{font-size:20px}.investment{display:grid;grid-template-columns:49% 51%;gap:12px}.price{min-height:160px;border:2px solid #e2b000;border-left:11px solid #ffd000;border-radius:8px;padding:20px 22px;background:linear-gradient(110deg,#5a4300,#101516 70%);color:#fff}.price small{font-size:14px}.price strong{display:block;color:#ffd000;font-size:36px;margin:8px 0}.price span{font-size:14px;line-height:1.45}.conditions .card{min-height:49px;margin-bottom:6px;padding:8px 16px}.scope{padding:12px 17px;min-height:140px;font-size:13px;line-height:1.8;position:relative}.wm{position:absolute;right:18px;bottom:-5px;font-size:100px;font-weight:900;color:rgba(222,169,24,.16)}.bottom{display:grid;grid-template-columns:1.2fr .8fr;gap:20px;align-items:center}.obs{padding:10px 14px;font-size:12px;line-height:1.5}.quote{color:#e7a700;font-size:20px;font-weight:900;text-align:center}.footer{border-top:4px solid #e7b900;background:#fff;padding:17px 26px 20px}.contacts{display:flex;gap:30px;align-items:center;font-size:12px}.footLogo{text-align:right;margin-top:12px}.footLogo img{height:65px;width:auto;max-width:240px;object-fit:contain}@media(max-width:760px){.hero{grid-template-columns:1fr 200px}.grid2,.grid3,.equipment,.investment,.bottom{grid-template-columns:1fr}.photo{height:240px}}@media print{.toolbar{display:none}.stage{padding:0}.sheet{width:100%;border:0;box-shadow:none}*{-webkit-print-color-adjust:exact!important;print-color-adjust:exact!important}@page{size:A4 portrait;margin:0}}
 ...
 <header class="hero"><div class="identity"><div class="logo"><b>M</b>AQON</div><div class="tag">CONSULTORIA EM EQUIPAMENTOS PESADOS</div><div class="strategy">PLANEJAMENTO • DADOS • ESTRATÉGIA • RESULTADOS</div><div class="future">EQUIPAMENTOS QUE<b>CONSTROEM O SEU FUTURO</b></div></div><aside class="proposal"><h1>PROPOSTA<b>COMERCIAL</b></h1><div class="num">Nº: ${esc(num)}</div><div class="benefit">◆ SOLUÇÕES REAIS</div><div class="benefit">■ MAIS PRODUTIVIDADE</div><div class="benefit">⚙ MENOR CUSTO OPERACIONAL</div><div class="benefit">◆ PARCERIA DE LONGO PRAZO</div><div class="benefit" style="white-space:normal;margin-top:16px">DO PLANEJAMENTO À OPERAÇÃO, SEMPRE AO SEU LADO.</div></aside></header>
 <div class="body"><div class="section">CLIENTE E PROPOSTA</div><div class="grid2"><div class="card"><small>CLIENTE</small><strong>${esc(p.client)}</strong></div><div class="card"><small>EMPRESA</small><strong>${esc(p.company||'—')}</strong></div></div><div class="grid3" style="margin-top:9px"><div class="card"><small>MODALIDADE</small><strong>${esc(p.mode)}</strong></div><div class="card"><small>VALIDADE DA PROPOSTA</small><strong>${esc(validity)}</strong></div><div class="card"><small>DATA DE EMISSÃO</small><strong>${esc(issue)}</strong></div></div>
 <div class="section">EQUIPAMENTO</div><div class="equipment"><div class="photo"></div><div class="details"><h2>${esc(maker)} ${esc(model)} — ${esc(category)}</h2><p>${esc(desc)}</p><div class="specs">${specs.map(s=>`<div class="spec"><small>${esc(s[0])}</small><b>${esc(s[1])}</b></div>`).join('')}</div></div></div>
 <div class="section">INVESTIMENTO</div><div class="investment"><div class="price"><small>VALOR TOTAL</small><strong>${brl(p.value)}</strong><span>Investimento conforme proposta comercial<br>(Valores sujeitos à alteração)</span></div><div class="conditions"><div class="card"><small>CONDIÇÕES DE PAGAMENTO</small><strong>${esc(p.terms||'A combinar / financiamento / consórcio')}</strong></div><div class="card"><small>PRAZO DE ENTREGA</small><strong>A combinar</strong></div><div class="card"><small>GARANTIA</small><strong>Conforme fabricante / negociação</strong></div></div></div>
 ...
 <footer class="footer"><div class="contacts"><span>☎ (98) 99999-9999</span><span>✉ contato@maqon.com.br</span><span>in /maqon</span></div><div class="footLogo"><img src="maqon-logo-original-aprovada.png" alt="MAQON"></div></footer>
