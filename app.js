...
function viewProposal(i){
 ...
 const num=proposalNumber(i),company=p.company||'—',scope=p.scope||'—',terms=p.terms||'Conforme negociação.';
 ...
 const eqIndex=equipments.findIndex(x=>equipmentName(x)===p.equipment),eq=eqIndex>=0?equipments[eqIndex]:null;
 ...
 *{box-sizing:border-box}body{margin:0;background:#02080b;color:#f4f7f8;font-family:Arial,Helvetica,sans-serif}.page{width:min(1060px,calc(100% - 20px));margin:12px auto;background:linear-gradient(135deg,#071116,#061015 70%,#11140f);border:1px solid #3c4b50;box-shadow:0 20px 70px #000;overflow:hidden}.hero{display:grid;grid-template-columns:1fr 320px;min-height:250px;border-bottom:3px solid #e4b900;background:radial-gradient(circle at 62% 45%,#6b4d13 0,#18201d 23%,#071015 60%)}.hero-main{padding:30px 36px;position:relative}.brand{font-size:54px;font-weight:900;letter-spacing:1px;line-height:1}.brand .m{color:#f4c400;text-shadow:0 2px 0 #755900}.brand .rest{color:#fff}.tag{font-weight:800;letter-spacing:1.5px;margin-top:7px}.strap{font-size:12px;letter-spacing:2px;color:#d4dde0;margin-top:15px}.future{margin-top:30px;font-size:18px}.future b{display:block;color:#f4c400;font-size:23px}.machine-art{position:absolute;right:20px;bottom:10px;width:220px;height:115px;opacity:.25;border:2px solid #f4c400;border-radius:60% 40% 12px 12px;transform:skewX(-10deg)}.hero-side{padding:30px 28px;border-left:2px solid #e4b900;background:#061014}.hero-side h1{margin:0;color:#fff;font-size:27px}.hero-side h1 b{display:block;color:#f4c400;font-size:32px}.hero-side .num{font-size:17px;margin:7px 0 18px}.benefit{padding:7px 0;font-weight:700}.benefit i{color:#f4c400;font-style:normal;margin-right:9px}.content{padding:18px 36px 26px}.section{margin:0 0 18px}.section-title{display:flex;align-items:center;gap:10px;color:#f4c400;font-size:18px;font-weight:900;text-transform:uppercase;margin:0 0 12px}.section-title:after{content:"";height:2px;background:#d3a900;flex:1}.grid2,.grid3{display:grid;gap:8px}.grid2{grid-template-columns:1fr 1fr}.grid3{grid-template-columns:repeat(3,1fr)}.card{border:1px solid #30434c;background:#0b171d;border-radius:7px;padding:12px 15px}.card small{display:block;color:#91a6af;text-transform:uppercase;font-size:11px;margin-bottom:5px}.card strong{font-size:16px}.equipment{display:grid;grid-template-columns:46% 54%;gap:10px}.equipment-photo{min-height:220px;border:1px solid #5d4b13;border-radius:8px;background:radial-gradient(circle at 70% 25%,#d49c29 0,#4a3818 18%,#17201d 45%,#071015 75%);position:relative;overflow:hidden}.equipment-photo:before{content:"KOMATSU";position:absolute;left:45px;top:78px;color:#f4c400;font-size:32px;font-weight:900;transform:rotate(-8deg);opacity:.9}.equipment-photo:after{content:"PC210";position:absolute;right:25px;bottom:30px;color:#fff;font-size:28px;font-weight:900}.eqinfo{padding:16px;border:1px solid #30434c;border-radius:8px;background:#0a151a}.eqinfo h2{color:#f4c400;margin:0 0 12px;font-size:21px}.eqinfo p{line-height:1.45;color:#dce5e8}.specs{display:grid;grid-template-columns:repeat(3,1fr);gap:5px;margin-top:20px}.spec{border-top:1px solid #34464e;padding-top:10px}.spec small{display:block;color:#91a6af}.spec b{font-size:16px}.investment{display:grid;grid-template-columns:1fr 1fr;gap:14px}.price{padding:22px;border:1px solid #e4b900;border-left:10px solid #f4c400;border-radius:8px;background:linear-gradient(120deg,#4c3a0c,#0a1113 72%)}.price small{font-weight:800}.price strong{display:block;color:#f4c400;font-size:39px;margin:8px 0}.terms .card{margin-bottom:6px}.scope{border:1px solid #30434c;background:#0a151a;border-radius:8px;padding:14px 18px;line-height:1.6;white-space:pre-wrap}.scope:before{content:"✓";color:#f4c400;font-weight:900;margin-right:10px}.quote{display:grid;grid-template-columns:1fr 1fr;gap:22px;align-items:center}.quote b{color:#f4c400;font-size:20px}.bottom{display:flex;justify-content:space-between;gap:20px;padding:18px 36px;border-top:3px solid #e4b900;background:#061014;font-size:12px}.bottom strong{color:#f4c400}.actions{width:min(1060px,calc(100% - 20px));margin:0 auto 25px;display:flex;justify-content:flex-end;gap:8px}.actions button{border:0;border-radius:6px;padding:11px 18px;font-weight:800;cursor:pointer}.print{background:#f4c400}.close{background:#26343b;color:#fff}@media(max-width:760px){.hero{grid-template-columns:1fr}.hero-side{border-left:0;border-top:1px solid #e4b900}.grid2,.grid3,.equipment,.investment,.quote{grid-template-columns:1fr}.content,.hero-main,.hero-side,.bottom{padding-left:20px;padding-right:20px}.machine-art{display:none}}@media print{body{background:#fff}.page{width:100%;margin:0;box-shadow:none}.actions{display:none}*{-webkit-print-color-adjust:exact!important;print-color-adjust:exact!important}@page{size:A4;margin:6mm}}
 </style></head><body><article class="page"><header class="hero"><div class="hero-main"><div class="brand"><span class="m">M</span><span class="rest">AQON</span></div><div class="tag">CONSULTORIA EM EQUIPAMENTOS PESADOS</div><div class="strap">PLANEJAMENTO • DADOS • ESTRATÉGIA • RESULTADOS</div><div class="future">EQUIPAMENTOS QUE <b>CONSTROEM O SEU FUTURO</b></div><div class="machine-art"></div></div><aside class="hero-side"><h1>PROPOSTA <b>COMERCIAL</b></h1><div class="num">${esc(num)}</div><div class="benefit"><i>◆</i>SOLUÇÕES REAIS</div><div class="benefit"><i>▥</i>MAIS PRODUTIVIDADE</div><div class="benefit"><i>⚙</i>MENOR CUSTO OPERACIONAL</div><div class="benefit"><i>◆</i>PARCERIA DE LONGO PRAZO</div></aside></header><main class="content">
 <section class="section"><div class="section-title">● Cliente e proposta</div><div class="grid2"><div class="card"><small>Cliente</small><strong>${esc(p.client)}</strong></div><div class="card"><small>Empresa</small><strong>${esc(company)}</strong></div></div><div class="grid3" style="margin-top:8px"><div class="card"><small>Modalidade</small><strong>${esc(p.mode)}</strong></div><div class="card"><small>Validade da proposta</small><strong>${esc(valid)}</strong></div><div class="card"><small>Data de emissão</small><strong>${esc(issue)}</strong></div></div></section>
 <section class="section"><div class="section-title">◆ Equipamento</div><div class="equipment"><div class="equipment-photo"></div><div class="eqinfo"><small>EQUIPAMENTO SELECIONADO</small><h2>${esc(p.equipment)}</h2><p>Equipamento selecionado para atendimento da necessidade apresentada, com foco em produtividade, confiabilidade e custo operacional.</p><div class="specs"><div class="spec"><small>Ano</small><b>${eq?esc(eq[3]):'—'}</b></div><div class="spec"><small>Horímetro</small><b>${eq?esc(eq[4])+' h':'—'}</b></div><div class="spec"><small>Disponibilidade</small><b>${eq?esc(eq[8])+'%':'—'}</b></div></div></div></div></section>
 <section class="section"><div class="section-title">● Investimento</div><div class="investment"><div class="price"><small>VALOR TOTAL</small><strong>${brl(p.value)}</strong><span>Investimento conforme proposta comercial</span></div><div class="terms"><div class="card"><small>Condições de pagamento</small><strong>${esc(terms)}</strong></div><div class="card"><small>Prazo de entrega</small><strong>A combinar</strong></div><div class="card"><small>Garantia</small><strong>Conforme fabricante / negociação</strong></div></div></div></section>
 <section class="section"><div class="section-title">▤ Escopo da proposta</div><div class="scope">${esc(scope)}</div></section>
 <section class="section quote"><div><div class="section-title">● Observações</div><p>Esta proposta é válida pelo período informado e pode ser ajustada conforme negociação. Valores e condições sujeitos à validação final.</p></div><div><b>“MÁQUINAS CERTAS,<br>RESULTADOS MAIORES.”</b><p><strong>MAQON</strong><br>CONSULTORIA EM EQUIPAMENTOS PESADOS</p></div></section>
 </main><footer class="bottom"><span><strong>MAQON</strong> • Consultoria em Equipamentos Pesados</span><span>PLANEJANDO HOJE, CONSTRUINDO GRANDES RESULTADOS AMANHÃ.</span></footer></article><div class="actions"><button class="close" onclick="window.close()">Fechar</button><button class="print" onclick="window.print()">Imprimir / Salvar em PDF</button></div></body></html>`;
