...
const maqonEquipmentSync=document.querySelector('#proposalEquipment');
if(maqonEquipmentSync)maqonEquipmentSync.addEventListener('change',()=>{
 const eq=equipments[Number(maqonEquipmentSync.value)],v=document.querySelector('#proposalValue');
...
function viewProposal(i){
 ...
 const id=norm(maker+' '+model),key=norm(category);
 ...
 else if(key.includes('retro')){photo='maqon-retroescavadeira.jpg';desc='Retroescavadeira para escavação, carregamento e apoio em obras.'}
 else if(key.includes('motonivel')){photo='maqon-motoniveladora.jpg';desc='Motoniveladora para nivelamento e acabamento de vias e terrenos.'}
 else if(key.includes('carregadeira')){photo='maqon-pa-carregadeira.jpg';desc='Pá carregadeira para carregamento e movimentação de materiais.'}
 else if(key.includes('trator')){photo='maqon-trator-esteiras.jpg';desc='Trator de esteiras para terraplenagem e preparação de terrenos.'}
 else if(key.includes('guindaste')){photo='maqon-guindaste.jpg';desc='Guindaste para içamento e movimentação segura de cargas.'}
 else if(key.includes('munck')){photo='maqon-munck.jpg';desc='Caminhão munck para transporte, içamento e movimentação de cargas.'}
 else if(key.includes('basculante')){photo='maqon-caminhao-basculante.jpg';desc='Caminhão basculante para transporte e descarga de materiais.'}
 else if(key.includes('pipa')){photo='maqon-caminhao-pipa.jpg';desc='Caminhão-pipa para abastecimento e apoio operacional.'}
 else if(key.includes('escav')){photo='maqon-escavadeira.jpg';desc='Escavadeira para escavação, carregamento e terraplenagem.'}
 ...
 *{box-sizing:border-box}html,body{margin:0;background:#061015;color:#fff;font-family:Arial,Helvetica,sans-serif}.bar{height:48px;background:#0b1820;display:flex;align-items:center;justify-content:space-between;padding:0 18px;position:sticky;top:0;z-index:9}.bar button{border:0;border-radius:5px;padding:9px 13px;font-weight:800;margin-left:7px;cursor:pointer}.print{background:#ffd000}.close{background:#263740;color:#fff}.stage{padding:14px;display:flex;justify-content:center}.page{width:794px;background:#020b10;border:1px solid #263b44;box-shadow:0 12px 45px #000;overflow:hidden}.hero{height:250px;position:relative;background:url('maqon-identidade-referencia.png') left center/cover no-repeat;border-bottom:3px solid #e6bb00}.heroRight{position:absolute;right:0;top:0;width:185px;height:100%;padding:20px 14px;background:#03090c;border-left:3px solid #e6bb00}.heroRight h1{font-size:20px;line-height:1.05;margin:0}.heroRight h1 b{display:block;color:#ffd000;font-size:27px}.heroRight .num{font-weight:900;margin:8px 0 19px}.heroRight p{font-size:10px;line-height:1.35;margin:9px 0}.body{padding:0 24px 14px}.title{display:flex;align-items:center;gap:11px;color:#ffd000;font-size:16px;font-weight:900;margin:10px 0}.title:after{content:"";height:2px;background:#e6bb00;flex:1}.g2,.g3{display:grid;gap:8px}.g2{grid-template-columns:1fr 1fr}.g3{grid-template-columns:repeat(3,1fr)}.box,.details,.scope{background:#06171f;border:1px solid #35525e;border-radius:7px}.box{padding:10px 14px;min-height:57px}.box small,.details small,.spec small{display:block;color:#bdc9cd;font-size:9px;margin-bottom:5px}.box strong{font-size:14px}.equipment{display:grid;grid-template-columns:46% 54%;gap:10px}.photo{height:205px;background:url('${photo}') center/cover no-repeat;border:1px solid #d3a900;border-radius:7px}.details{padding:14px 17px}.details h2{color:#ffd000;font-size:20px;margin:0 0 14px}.details p{font-size:12px;line-height:1.5;min-height:55px}.specs{display:grid;grid-template-columns:repeat(3,1fr);border-top:1px solid #65767d;padding-top:13px}.spec{padding:0 9px;border-right:1px solid #52656d}.spec:first-child{padding-left:0}.spec:last-child{border:0}.spec b{font-size:17px}.investment{display:grid;grid-template-columns:49% 51%;gap:10px}.price{min-height:142px;border:1px solid #e6bb00;border-left:10px solid #ffd000;border-radius:8px;padding:17px 18px;background:radial-gradient(circle at 28% 12%,#5b4508,#111515 57%,#071014)}.price small{font-size:12px}.price strong{display:block;color:#ffd000;font-size:31px;margin:8px 0}.price span{font-size:12px;line-height:1.45}.conditions .box{min-height:43px;margin-bottom:5px;padding:7px 14px}.scope{padding:10px 14px;min-height:125px;font-size:11px;line-height:1.75;position:relative}.wm{position:absolute;right:17px;bottom:-3px;font-size:82px;font-weight:900;color:rgba(183,137,23,.28)}.bottom{display:grid;grid-template-columns:1.25fr .75fr;gap:17px;align-items:center}.obs{background:#06171f;padding:9px 12px;font-size:10px;line-height:1.45}.quote{color:#ffd000;font-size:17px;font-weight:900;text-align:center}.footer{border-top:4px solid #e6bb00;padding:14px 24px 17px;background:linear-gradient(100deg,#061016 0,#061016 67%,#171205 100%)}.contacts{display:flex;gap:27px;font-size:10px}.brand{text-align:right;color:#ffd000;font-size:24px;font-weight:900;margin-top:8px}.brand small{display:block;color:#fff;font-size:8px;font-weight:400}@media print{.bar{display:none}.stage{padding:0}.page{border:0;box-shadow:none}*{-webkit-print-color-adjust:exact!important;print-color-adjust:exact!important}@page{size:A4;margin:0}}@media(max-width:800px){.page{width:100%}.g2,.g3,.equipment,.investment,.bottom{grid-template-columns:1fr}.heroRight{width:175px}.photo{height:230px}}
 </style></head><body><div class="bar"><b>Proposta Comercial — ${esc(num)}</b><div><button class="close" onclick="window.close()">Fechar</button><button class="print" onclick="window.print()">Imprimir / Salvar PDF</button></div></div><main class="stage"><article class="page">
 <header class="hero"><aside class="heroRight"><h1>PROPOSTA<b>COMERCIAL</b></h1><div class="num">Nº: ${esc(num)}</div><p>◈ SOLUÇÕES REAIS</p><p>▰ MAIS PRODUTIVIDADE</p><p>⚙ MENOR CUSTO OPERACIONAL</p><p>◆ PARCERIA DE LONGO PRAZO</p><p style="margin-top:15px">DO PLANEJAMENTO À OPERAÇÃO, SEMPRE AO SEU LADO.</p></aside></header>
 <div class="body"><div class="title">● CLIENTE E PROPOSTA</div><div class="g2"><div class="box"><small>CLIENTE</small><strong>${esc(p.client)}</strong></div><div class="box"><small>EMPRESA</small><strong>${esc(p.company||'—')}</strong></div></div><div class="g3" style="margin-top:8px"><div class="box"><small>MODALIDADE</small><strong>${esc(p.mode)}</strong></div><div class="box"><small>VALIDADE DA PROPOSTA</small><strong>${esc(validity)}</strong></div><div class="box"><small>DATA DE EMISSÃO</small><strong>${esc(issue)}</strong></div></div>
 <div class="title">● EQUIPAMENTO</div><div class="equipment"><div class="photo"></div><div class="details"><h2>${esc(maker)} ${esc(model)} — ${esc(category)}</h2><p>${esc(desc)}</p><div class="specs">${specs.map(s=>`<div class="spec"><small>${esc(s[0])}</small><b>${esc(s[1])}</b></div>`).join('')}</div></div></div>
 <div class="title">● INVESTIMENTO</div><div class="investment"><div class="price"><small>VALOR TOTAL</small><strong>${brl(p.value)}</strong><span>Investimento conforme proposta comercial<br>(Valores sujeitos à alteração)</span></div><div class="conditions"><div class="box"><small>CONDIÇÕES DE PAGAMENTO</small><strong>${esc(p.terms||'A combinar / financiamento')}</strong></div><div class="box"><small>PRAZO DE ENTREGA</small><strong>A combinar</strong></div><div class="box"><small>GARANTIA</small><strong>Conforme fabricante</strong></div></div></div>
 <div class="title">▤ ESCOPO DA PROPOSTA</div><div class="scope">✓ ${esc(p.scope||'Aquisição para operação.')}<br>✓ Suporte na análise técnica e comparativa com outras opções de mercado.<br>✓ Orientação sobre manutenção preventiva e custo operacional.<br>✓ Acompanhamento no processo de aquisição e entrega do equipamento.<br>✓ Treinamento operacional básico (conforme fabricante).<span class="wm">M</span></div>
 <div class="bottom"><div><div class="title">● OBSERVAÇÕES</div><div class="obs">Esta proposta é válida pelo período informado e pode ser ajustada conforme negociação. Valores sujeitos à alteração sem aviso prévio.</div></div><div class="quote">“Máquinas certas,<br>resultados maiores.”</div></div></div>
 <footer class="footer"><div class="contacts"><span>☎ (98) 99999-9999</span><span>✉ contato@maqon.com.br</span><span>in /maqon</span></div><div class="brand">MAQON<small>CONSULTORIA EM EQUIPAMENTOS PESADOS</small></div></footer>
