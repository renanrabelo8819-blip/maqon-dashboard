...
function viewProposal(i){
 ...
 const desc=`${category} ${maker} ${model}`.trim()+'. Equipamento selecionado conforme especificações cadastradas na plataforma MAQON.';
 ...
 *{box-sizing:border-box}html,body{margin:0;background:#e9edef;color:#15191c;font-family:Arial,Helvetica,sans-serif}.toolbar{height:54px;background:#111820;color:#fff;display:flex;align-items:center;justify-content:space-between;padding:0 22px;position:sticky;top:0;z-index:20}.toolbar button{border:0;border-radius:5px;padding:9px 15px;font-weight:800;cursor:pointer;margin-left:8px}.gold{background:#f2b900}.dark{background:#34424b;color:#fff}.stage{padding:18px;display:flex;justify-content:center}.sheet{position:relative;width:min(794px,100%);min-height:1123px;background:#fff;box-shadow:0 10px 32px #89939a;border:1px solid #c9cfd3;overflow:hidden}.top{height:160px;display:grid;grid-template-columns:1fr 190px;border-bottom:1px solid #d9dde0}.identity{position:relative;padding:18px 22px 12px 24px;display:flex;align-items:center;gap:24px}.identity img{width:270px;height:auto;object-fit:contain}.taglines{flex:1}.taglines .strategy{font-size:11px;font-weight:800;color:#3f4548;letter-spacing:.4px;border-bottom:3px solid #e7ad00;padding-bottom:10px}.taglines .future{font-size:12px;font-weight:800;color:#4b5053;margin-top:12px}.taglines .future b{display:block;color:#e8a900;font-size:18px;margin-top:3px}.proposalBox{border-left:1px solid #d8dcdf;padding:20px 16px;background:#fbfbfb}.proposalBox h1{font-size:19px;line-height:1;margin:0 0 16px}.proposalBox h1 b{display:block;color:#e6a800;font-size:22px;margin-top:3px}.proposalBox p{font-size:10px;line-height:1.6;margin:5px 0}.content{padding:13px 28px 0}.section{display:flex;align-items:center;gap:10px;font-size:14px;font-weight:900;margin:10px 0 8px}.section .ico{width:27px;height:27px;border-radius:50%;display:grid;place-items:center;background:#111;color:#f0b500;font-size:14px}.section:after{content:"";height:2px;background:#e5aa00;flex:1}.grid2,.grid3{display:grid;gap:7px}.grid2{grid-template-columns:1fr 1fr}.grid3{grid-template-columns:1fr 1fr 1fr}.card{border:1px solid #68727a;border-radius:4px;padding:7px 9px;background:#fff;min-height:44px}.card small{display:block;color:#626a70;font-size:8px;text-transform:uppercase;margin-bottom:3px}.card strong{font-size:11px}.equipment{display:grid;grid-template-columns:48% 52%;gap:10px;align-items:stretch}.machine{height:230px;border:0;background:#fff;display:flex;align-items:center;justify-content:center;overflow:hidden}.machine img{width:100%;height:100%;object-fit:contain}.eqinfo{border:1px solid #aab0b4;border-radius:4px;padding:14px 13px;display:flex;flex-direction:column}.eqinfo h2{font-size:18px;color:#e6a800;margin:0 0 9px}.eqinfo p{font-size:10px;line-height:1.5;margin:0}.specs{display:grid;grid-template-columns:repeat(3,1fr);gap:7px;border-top:1px solid #8d9498;margin-top:auto;padding-top:11px}.spec{border-right:1px solid #c0c4c7;padding-right:5px}.spec:last-child{border:0}.spec small{display:block;color:#626a70;font-size:8px}.spec b{font-size:12px}.investment{display:grid;grid-template-columns:49% 51%;gap:8px}.price{border:1px solid #2b3033;border-left:9px solid #efb400;border-radius:5px;padding:14px 13px;background:linear-gradient(105deg,#3c300a,#111516 72%);color:#fff}.price small{font-size:11px;font-weight:800}.price strong{display:block;color:#ffc400;font-size:29px;margin:7px 0}.price span{font-size:9px}.conditions .card{margin-bottom:5px;min-height:41px}.scope{position:relative;border:1px solid #7c858b;border-radius:4px;padding:10px 12px;font-size:9px;line-height:1.55;overflow:hidden}.scope:after{content:"M";position:absolute;right:12px;bottom:-22px;font-size:110px;font-weight:900;color:rgba(230,174,0,.10)}.bottom{display:grid;grid-template-columns:1.45fr .75fr;gap:22px;align-items:center;padding-bottom:14px}.obs{font-size:9px;line-height:1.45}.quote{color:#e6a800;font-size:18px;font-weight:900;text-align:right}.footer{height:82px;border-top:3px solid #e7ad00;display:grid;grid-template-columns:1fr 260px;margin-top:5px}.contacts{display:flex;align-items:center;gap:15px;padding:0 28px;font-size:8px}.footbrand{position:relative;background:#0c1114;color:#fff;display:flex;align-items:center;justify-content:center;overflow:hidden}.footbrand:before{content:"";position:absolute;left:-48px;top:0;border-top:82px solid transparent;border-right:70px solid #e8ad00}.footbrand img{width:155px;height:auto;filter:none;position:relative;z-index:2}.muted{color:#6b7277}@media(max-width:760px){.top{height:auto;grid-template-columns:1fr}.proposalBox{border-left:0;border-top:1px solid #ddd}.identity{align-items:flex-start;flex-direction:column}.identity img{width:230px}.grid2,.grid3,.equipment,.investment,.bottom{grid-template-columns:1fr}.machine{height:240px}.footer{grid-template-columns:1fr}.footbrand{display:none}}@media print{html,body{background:#fff}.toolbar{display:none}.stage{padding:0}.sheet{width:210mm;min-height:297mm;box-shadow:none;border:0}*{-webkit-print-color-adjust:exact!important;print-color-adjust:exact!important}@page{size:A4;margin:0}}
 ...
 <header class="top"><div class="identity"><img src="maqon-logo-original-aprovada.png" alt="MAQON"><div class="taglines"><div class="strategy">PLANEJAMENTO • DADOS • ESTRATÉGIA • RESULTADOS</div><div class="future">EQUIPAMENTOS QUE<b>CONSTROEM O SEU FUTURO</b></div></div></div><aside class="proposalBox"><h1>PROPOSTA <b>COMERCIAL</b></h1><p><b>Nº: ${esc(num)}</b></p><p><b>DATA: ${esc(issue)}</b></p></aside></header>
 <div class="content"><div class="section"><span class="ico">●</span>CLIENTE E PROPOSTA</div><div class="grid2"><div class="card"><small>Cliente</small><strong>${esc(p.client)}</strong></div><div class="card"><small>Empresa</small><strong>${esc(p.company||'—')}</strong></div></div><div class="grid3" style="margin-top:7px"><div class="card"><small>Modalidade</small><strong>${esc(p.mode)}</strong></div><div class="card"><small>Validade da proposta</small><strong>${esc(validity)}</strong></div><div class="card"><small>Data de emissão</small><strong>${esc(issue)}</strong></div></div>
 <div class="section"><span class="ico">◆</span>EQUIPAMENTO</div><div class="equipment"><div class="machine"><img src="${photo}" alt="${esc(maker+' '+model)}"></div><div class="eqinfo"><h2>${esc(maker)} ${esc(model)} — ${esc(category)}</h2><p>${esc(desc)}</p><div class="specs"><div class="spec"><small>ANO</small><b>${esc(year)}</b></div><div class="spec"><small>HORÍMETRO</small><b>${esc(hours)} h</b></div><div class="spec"><small>DISPONIBILIDADE</small><b>${esc(availability)}%</b></div></div></div></div>
 <div class="section"><span class="ico">$</span>INVESTIMENTO</div><div class="investment"><div class="price"><small>VALOR TOTAL</small><strong>${brl(p.value)}</strong><span>Investimento conforme proposta comercial<br>(valores sujeitos à alteração).</span></div><div class="conditions"><div class="card"><small>Condições de pagamento</small><strong>${esc(p.terms||'A combinar / Financiamento bancário')}</strong></div><div class="card"><small>Prazo de entrega</small><strong>A combinar</strong></div><div class="card"><small>Garantia</small><strong>Conforme fabricante / negociação</strong></div></div></div>
 <div class="section"><span class="ico">✓</span>ESCOPO DA PROPOSTA</div><div class="scope">✓ ${esc(p.scope||`Aquisição de ${maker} ${model}.`)}<br>✓ Suporte na análise técnica e comparativa com outras opções de mercado.<br>✓ Orientação sobre manutenção preventiva e custo operacional.<br>✓ Acompanhamento no processo de aquisição e entrega do equipamento.<br>✓ Treinamento operacional básico (conforme fabricante).</div>
 <div class="bottom"><div><div class="section"><span class="ico">▤</span>OBSERVAÇÕES</div><div class="obs">Esta proposta é válida pelo período informado e pode ser ajustada conforme negociação. Valores e condições sujeitos à alteração sem aviso prévio.</div></div><div class="quote">“Máquinas certas,<br>resultados maiores.”</div></div></div>
 <footer class="footer"><div class="contacts"><span>☎ (98) 99220-2920</span><span>✉ contato@maqon.com.br</span><span>in /maqon</span></div><div class="footbrand"><img src="maqon-logo-original-aprovada.png" alt="MAQON"></div></footer>
